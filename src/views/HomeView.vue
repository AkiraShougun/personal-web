<script setup>
import Linker from '../components/LinkView.vue'
</script>
  ...
  <main class="mx-11 lg:mx-60 my-10">
    ...
    <div class="max-w-96 my-5 rounded-md">
      <div class="bg-[#2b2d31] min-h-24 flex rounded-lg rounded-b-none border-b-2 border-cyan-300">
        ...
        <span class="my-9 text-xl text-white">despairful_deltoid</span>
      </div>
      <div class="bg-gray-800 rounded-lg rounded-t-none">
        <Linker link="https://github.com/AkiraShougun" name="AkiraShougun">
          <svg
        ...
        <Linker name="Canada" link="https://www.canada.ca/en.html">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
